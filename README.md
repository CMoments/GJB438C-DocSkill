...
| 触发关键词 | 触发 Skill |
|:---|:---|
| `438C` `5.10` `需求规格说明` `SRS` `软件需求` | `[08]` 软件需求规格说明书 |
| `438C` `5.11` `SDD` `软件设计说明` `概要设计` | `[10]` 软件概要设计说明书 |
...
|:---:|:---|:---:|:---:|:---:|
| [10] | 软件需求规格说明 | SRS | [08] 软件需求规格说明 | ✅ 已支持 |
| [11] | 软件设计说明 | SDD | [10] 软件概要设计说明 | ✅ 已支持 |
...
├── skills/
│   ├── word-fillter-438c-srs/    # [08] 软件需求规格说明书
│   │   ├── SKILL.md             # Skill 定义
│   │   ├── documents/           # 模板 .docx
...
│   └── word-fillter-438c-sdd/    # [10] 软件概要设计说明书
│       ├── SKILL.md
│       ├── documents/
│       ├── templates/
│       └── scripts/
